        ...
        <div className="row mt-4">
          <div className="content__one col-md-12 col-lg-6">
            ...
            <p className="text-left about__content">
              ...
              professional home care services tailored to meet the unique needs
              of your loved ones. Our mission is to ensure comfort, safety, and
              independence in the familiar surroundings of home.
            </p>
